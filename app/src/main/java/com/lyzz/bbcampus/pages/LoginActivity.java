...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private Button backbutton;//返回anniu
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String flag=intent.getStringExtra("login");
        ...
        Button mEmailSignInButton = (Button) findViewById(R.id.sign);//登陆按钮
        ...
        registerbutton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(LoginActivity.this,RegisterDetail.class);
        ...
        backbutton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(LoginActivity.this,OwnerPage.class);
                startActivity(intent);
                onStop();
            }
        });
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, String> {
        ...
        private String url="http://112.74.41.59:3000/v1/user/login";

        UserLoginTask(String email, String password) {
            mEmail = email;
            mPassword = password;
        //content=String.valueOf(UserKey);
            content="email="+mEmail.toString() + "&password=" + mPassword.toString();
    }
        @Override
        ...
        protected void onPostExecute(final String success) {
            ...
            {
                Toast.makeText(LoginActivity.this,"遇到异常，请尝试重启或联系我们", Toast.LENGTH_SHORT).show();
            }else
            {
        ...
        private void userDetail(JSONObject detail)
        {
            ...
            try {
                ...
                editor.putString("userAddress",object.getString("userAddress"));
