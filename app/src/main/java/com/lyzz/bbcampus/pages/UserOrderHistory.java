    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(UserOrderHistory.this,OwnerPage.class);
        ...
        if (loginInt!=0)
        {
            ...
            getuserorder=new getUserOrder("posterId="+user.getString("userId",""));
            getuserorder.execute((Void)null);
        }
        uservalue.setText(userstate.getString("userBangBiValue",""));
    }
    private void init()
    {
        list=new ArrayList<>();
    ...
    public class getUserOrder extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String success) {
            ...
            if (success.equals("error")) {
                Toast.makeText(UserOrderHistory.this,"网络未连接", Toast.LENGTH_SHORT).show();
            }
            else if(success.equals("false"))
            {
                Toast.makeText(UserOrderHistory.this,"遇到异常，请尝试重启或联系我们", Toast.LENGTH_SHORT).show();
            }else
            {
                ...
                try {
                    ...
                    if(code.equals("201"))
                    {
                        Toast.makeText(UserOrderHistory.this,"接受成功，跳转任务追踪页面",Toast.LENGTH_SHORT);
                        JSONArray array;
                    ...
                    {
                        Toast.makeText(UserOrderHistory.this,object.getString("message"), Toast.LENGTH_SHORT).show();
                    }
