...
public class OrderWash extends AppCompatActivity {
    ...
    private static String ordertype="洗涤";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mylocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(OrderWash.this, OrderDetailLocation.class);
                int requestCode=0;
        ...
        subscribe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(checkdetail())
                {
                    Toast.makeText(OrderWash.this,"发送中", Toast.LENGTH_SHORT).show();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(OrderWash.this,Subscribe.class);
    ...
    private boolean checkdetail()
    {
        ...
        {
            Toast.makeText(OrderWash.this, "请填写完整求助信息", Toast.LENGTH_SHORT).show();
        }
        return flag;
    }
    ...
    protected void onActivityResult(int requestCode,int resultCode,Intent data)
    {
        if(requestCode==0&&resultCode==0)
        {
            ...
            }else
            {
                ...
                Toast.makeText(OrderWash.this,"可手动输入地点信息", Toast.LENGTH_SHORT).show();
            }
    ...
    public class OrderSubscribeTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String success) {
            ...
            if (success.equals("error")) {
                Toast.makeText(OrderWash.this,"网络未连接", Toast.LENGTH_SHORT).show();
            }
            else if(success.equals("false"))
            {
                Toast.makeText(OrderWash.this,"遇到异常，请尝试重启或联系我们", Toast.LENGTH_SHORT).show();
            }else
            {
                ...
                try {
                    ...
                    if(code.equals("201"))
                    {
                        ...
                        //添加处理函数
                        Intent intent=new Intent(OrderWash.this,MainLBS.class);
                        startActivity(intent);
                    }else
                    {
                        Toast.makeText(OrderWash.this,object.getString("message"), Toast.LENGTH_SHORT).show();
                    }
