...
public class OrderExpress extends AppCompatActivity {
    ...
    private ImageButton mylocationButton,buylocationButton;
    private HashMap<String,String> buylocation_map,mylocation_map;
    private static String ordertype="快递";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buylocationButton=(ImageButton)findViewById(R.id.buylocationbutton);
        mylocationButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(OrderExpress.this, OrderDetailLocation.class);
                int requestCode=0;
                startActivityForResult(intent,requestCode);
            }
        });
        buylocationButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(OrderExpress.this,OrderDetailLocation.class);
                int requestCode=1;
        ...
        subscribe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(checkdetail())
                {
                    Toast.makeText(OrderExpress.this,"发送中", Toast.LENGTH_SHORT).show();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(OrderExpress.this,Subscribe.class);
    ...
    {
        boolean flag=false;
        if(!TextUtils.isEmpty(title.getText().toString())&&!TextUtils.isEmpty(thing.getText().toString())&&!(buylocation_map==null)&&!(mylocation_map==null))
        {
            flag=true;
        }
        else
        {
            Toast.makeText(OrderExpress.this, "请填写完整求助信息", Toast.LENGTH_SHORT).show();
        }
        return flag;
    }
    ...
    protected void onActivityResult(int requestCode,int resultCode,Intent data)
    {
        if(requestCode==0&&resultCode==0)
        {
            ...
            }else
            {
                ...
                Toast.makeText(OrderExpress.this,"可手动输入地点信息", Toast.LENGTH_SHORT).show();
            }

        }
        else if(requestCode==1&&resultCode==0)
        {
            buylocation_map=new HashMap<String,String>();
            buylocation_map.put("latitude",data.getStringExtra("latitude"));
            buylocation_map.put("longitude",data.getStringExtra("longitude"));
            if((data.getStringExtra("address")!=null)&&(data.getStringExtra("detail")!=null))
            {
                buylocation.setText(data.getStringExtra("address")+data.getStringExtra("detail"));
                buylocation.setTextSize(12);
            }else
            {
                buylocation.setText("未检索到位置信息");
                Toast.makeText(OrderExpress.this,"可手动输入地点信息", Toast.LENGTH_SHORT).show();
            }
    ...
    public class OrderSubscribeTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String success) {
            ...
            if (success.equals("error")) {
                Toast.makeText(OrderExpress.this,"网络未连接", Toast.LENGTH_SHORT).show();
            }
            else if(success.equals("false"))
            {
                Toast.makeText(OrderExpress.this,"遇到异常，请尝试重启或联系我们", Toast.LENGTH_SHORT).show();
            }else
            {
                ...
                try {
                    ...
                    if(code.equals("201"))
                    {
                        ...
                        //添加处理函数
                        Intent intent=new Intent(OrderExpress.this,MainLBS.class);
                        startActivity(intent);
                    }else
                    {
                        Toast.makeText(OrderExpress.this,object.getString("message"), Toast.LENGTH_SHORT).show();
                    }
