...
public class OrderSeat extends AppCompatActivity {
    ...
    private static String ordertype="占座";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mylocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(OrderSeat.this, OrderDetailLocation.class);
                int requestCode=0;
        ...
        subscribe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(checkdetail())
                {
                    Toast.makeText(OrderSeat.this,"发送中", Toast.LENGTH_SHORT).show();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(OrderSeat.this,Subscribe.class);
    ...
    private boolean checkdetail()
    {
        ...
        {
            Toast.makeText(OrderSeat.this, "请填写完整求助信息", Toast.LENGTH_SHORT).show();
        }
        return flag;
    }
    ...
    protected void onActivityResult(int requestCode,int resultCode,Intent data)
    {
        if(requestCode==0&&resultCode==0)
        {
            ...
            }else
            {
                ...
                Toast.makeText(OrderSeat.this,"可手动输入地点信息", Toast.LENGTH_SHORT).show();
            }
    ...
    public class OrderSubscribeTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String success) {
            ...
            if (success.equals("error")) {
                Toast.makeText(OrderSeat.this,"网络未连接", Toast.LENGTH_SHORT).show();
            }
            else if(success.equals("false"))
            {
                Toast.makeText(OrderSeat.this,"遇到异常，请尝试重启或联系我们", Toast.LENGTH_SHORT).show();
            }else
            {
                ...
                try {
                    ...
                    if(code.equals("201"))
                    {
                        ...
                        //添加处理函数
                        Intent intent=new Intent(OrderSeat.this,MainLBS.class);
                        startActivity(intent);
                    }else
                    {
                        Toast.makeText(OrderSeat.this,object.getString("message"), Toast.LENGTH_SHORT).show();
                    }
